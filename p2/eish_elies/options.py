...
class Options(UIMenu):
    ...
    def resize(self):
        ...
        self.button_resolution = Button('img/Button.png', 450, 450, 0.2, f"Resolution: {int(round(data['WIN_SCALE'] * 1600))} x {int(round(data['WIN_SCALE'] * 900))}", "Blue", "pristina", 40)
